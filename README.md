...
## Recent Updates (v2.2.0) - August 25, 2024

### Documentary Treatment System Improvements
- Improved documentary treatment detection logic with more flexible pattern matching
- Added automatic template generation for documentary treatments
- Reduced threshold for valid treatment detection
- Enhanced section extraction with better regex patterns
- Added helpful guidance for creating properly formatted treatments

## Previous Updates (v2.1.1) - July 4, 2024
