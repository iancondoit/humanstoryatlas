...
// This page is for the exploration view which was previously in page.tsx
  ...
  return (
    <div className="min-h-screen bg-[#0d1117]">
      ...
      <main className="flex-1 p-6 md:p-8 space-y-8 max-w-7xl mx-auto">
        ...
        {/* Under Construction */}
        <UnderConstruction 
          title="Discovery Tools Coming Soon"
          message="We're building powerful tools to help you explore narrative connections in your archives. For now, check out Jordi for narrative discovery."
        />
